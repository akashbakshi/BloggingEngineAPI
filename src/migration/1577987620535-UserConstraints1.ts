...
export class UserConstraints11577987620535 implements MigrationInterface {
    name = 'UserConstraints11577987620535'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `firstName` varchar(255) NOT NULL, `lastName` varchar(255) NOT NULL, UNIQUE INDEX `IDX_fe0bb3f6520ee0469504521e71` (`username`), UNIQUE INDEX `IDX_97672ac88f789774dd47f7c8be` (`email`), UNIQUE INDEX `IDX_772886e2f1f47b9ceb04a06e20` (`username`, `email`), PRIMARY KEY (`username`)) ENGINE=InnoDB", undefined);
    }
